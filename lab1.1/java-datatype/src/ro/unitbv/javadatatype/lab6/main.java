...
public class main {
	...
	public static void main(String[] args) {
		...
		studentdetails elev1 = new studentdetails("Biclineru", "Stefan", noterom[0], notemate[9]);
		studentdetails elev2 = new studentdetails("Popescu", "Mihai", noterom[1], notemate[8]);
		...
		studentdetails elev5 = new studentdetails("Vasile", "George", noterom[4], notemate[5]);
		...
		studentdetails elev8 = new studentdetails("Liviu", "Grigore", noterom[7], notemate[2]);
		...
		System.out.println(catalog.get("6a"));
